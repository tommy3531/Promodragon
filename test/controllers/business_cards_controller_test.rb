...
class BusinessCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_card" do
    assert_difference('BusinessCard.count') do
      post business_cards_url, params: { business_card: { imdb: @business_card.imdb, twitter: @business_card.twitter, user_id: @business_card.user_id } }
    end
  ...
  test "should update business_card" do
    patch business_card_url(@business_card), params: { business_card: { imdb: @business_card.imdb, twitter: @business_card.twitter, user_id: @business_card.user_id } }
